		...
		<div className="h-[100vh] bg-black overflow-auto">
			<div className="container mx-auto py-4">
				<p className="text-xl font-light text-white mb-4">
					In order to test copy codes from <code className="bg-blue-400/40 py-1 px-2 rounded text-base">.env</code> and paste <kbd className="bg-white/20 py-1 px-2 rounded text-base">ctrl + v</kbd> yapıp yapıştırın.
				</p>
